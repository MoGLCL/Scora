...
export declare const SKILL_LEVEL_ORDER: readonly SkillLevel[];
export declare function levelOrdinal(level: SkillLevel): number;
/**
...
export declare const SkillVerdict: {
     ...
     */
    readonly NOT_EXERCISED: "NOT_EXERCISED";
...
export declare const SkillObservationKind: {
    /** Direct designed evidence: a challenge targeting this skill, passed. */
    readonly DEMONSTRATED: "DEMONSTRATED";
    ...
    readonly CHALLENGE_FAILED: "CHALLENGE_FAILED";
};
export type SkillObservationKind = (typeof SkillObservationKind)[keyof typeof SkillObservationKind];
