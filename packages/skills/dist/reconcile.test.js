...
import { TrustLayer, clampUnit, EventId } from '@scora/trust-core';
import { SkillLevel, SkillObservationKind, SkillVerdict, } from "./contract.js";
import { aggregateConfidence, inferLevel, reconcileClaim } from "./reconcile.js";
/**
 * The refusals.
 *
 ...
 * report.
 */
const EVIDENCE = [EventId.unsafe('evt_000001')];
function claim(level = SkillLevel.ADVANCED) {
    return {
        skillId: 'skill_pg',
...
function observation(kind, layer, weight = 0.7, confidence = 0.8) {
    return {
        kind,
        layer,
