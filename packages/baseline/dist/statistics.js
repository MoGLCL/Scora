 ...
 */
export function robustZScore(observed, centre, mad) {
 ...
 */
export function sampleConfidence(samples, halfway = 8) {
    if (samples <= 0)
        return clampUnit(0);
 ...
 * of today's.
 */
export function recencyWeight(observedAt, now, halfLifeDays = 90) {
