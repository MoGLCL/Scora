...
import { hexHash, payloads } from '@scora/trust-features/testing';
import { DEPENDENT, FAST_DEVELOPER, HEAVY_ASSISTANCE_ENGAGED, HONEST_SOLO, HONEST_WITH_DOCS, SPARSE, STRUGGLING_BEGINNER, sessionStart, } from '@scora/trust-scoring/scenarios';
...
function repeat(count, at, everyMs, make) {
 ...
 */
export const ASSISTIVE_DICTATION = [
    sessionStart,
 ...
 */
export const REUSES_OWN_LIBRARY = [
    sessionStart,
 ...
 */
export const DEGRADED_CONNECTION = [
    sessionStart,
 ...
 * silence they chose.
 */
export const MINIMAL_CONSENT_SESSION = [
    sessionStart,
 ...
 */
export const EXTERNAL_AI_ADAPTED = [
    sessionStart,
 ...
 */
export const UNVERIFIED_ASSISTANCE = [
    sessionStart,
...
export const CORPUS = [
    ...
    },
    {
        ...
        justification: 'A developer using dictation or switch access produces input no hand produces. Flagging this is ' +
    ...
    },
    {
        ...
        justification: 'Byte-for-byte the same paste as the dependent session. Only what follows it differs, which is ' +
    ...
    },
    {
        ...
        justification: 'Absence of evidence is not evidence. A gap the platform failed to capture is the platform’s ' +
    ...
    },
    {
        ...
        justification: 'Exercising a consent right must lower Confidence and nothing else. If declining monitoring ' +
    ...
    },
    {
        ...
        justification: 'External AI is permitted. What is assessed is what they did with it, and a 0.72 adaptation ratio ' +
    ...
    },
    {
        ...
        labelSource: LabelSource.SYNTHETIC,
        traits: [],
        justification: 'Several independent conditions across several layers. A reviewer may still clear them — the ' +
    ...
    },
    {
        ...
        labelSource: LabelSource.SYNTHETIC,
        traits: [CaseTrait.HEAVY_AI_ASSISTANCE],
        justification: 'The concern is not the assistance, which is allowed. It is that nothing in the session shows ' +
    ...
    },
    {
        ...
        labelSource: LabelSource.SYNTHETIC,
        traits: [CaseTrait.DEGRADED_CAPTURE],
        justification: 'Enough to see a person was working, nowhere near enough to conclude anything about them. ' +
