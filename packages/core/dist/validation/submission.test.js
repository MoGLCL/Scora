...
import { ALL_EVENT_TYPES, TrustEventType } from "../events/types.js";
import { PAYLOAD_SCHEMAS, eventTypesMissingSchemas } from "./payloads.js";
import { RejectionCode, validateSubmission } from "./submission.js";
...
describe('validateSubmission', () => {
    ...
    it('collects several envelope problems in one rejection', () => {
        const result = validateSubmission(submission({ developerId: 'nope', sequence: -1, occurredAt: 'yesterday' }));
        assert.ok(!result.ok);
...
//# sourceMappingURL=submission.test.js.map