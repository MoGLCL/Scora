import type { AssessmentId, DeveloperId, EpochMs, EventId, SessionId, TaskId, TenantId } from '../primitives/index.ts';
...
export declare const EventSource: {
    ...
    readonly CALIBRATION_HARNESS: "CALIBRATION_HARNESS";
};
export type EventSource = (typeof EventSource)[keyof typeof EventSource];
/** Producers whose claims must be corroborated before they can affect Risk. */
export declare const UNTRUSTED_SOURCES: readonly EventSource[];
export declare function isUntrustedSource(source: EventSource): boolean;
/**
...
export declare function isTrustEvent(value: EventSubmission | TrustEvent): value is TrustEvent;
