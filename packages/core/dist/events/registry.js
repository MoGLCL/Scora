import { TrustLayer } from "./layers.js";
import { AiAssistanceEventType, CodeEvolutionEventType, EnvironmentEventType, ExternalEventType, HumanReviewEventType, InteractionEventType, InterviewEventType, RuntimeEventType, SkillEventType, SystemEventType, TrustEventType, TypingEventType, } from "./types.js";
/**
...
function define(entries) {
    ...
    for (const [type, seed] of Object.entries(entries)) {
        out[type] = {
            ...
            sufficientAlone: seed.polarity === EvidencePolarity.RISK_CONTRIBUTING
                ? false
...
const ENVIRONMENT_DEFINITIONS = define({
    ...
    [EnvironmentEventType.WINDOW_FOCUS_LOST]: {
        ...
        cardinality: 'high',
        requiresConsent: 'assessment',
        description: 'The assessment window lost focus. Ordinary during any real work session; never adverse on its own.',
    },
    ...
    [EnvironmentEventType.DEVICE_CONTEXT_CHANGED]: {
        ...
        cardinality: 'low',
        requiresConsent: 'assessment',
        description: 'The reported device, browser or screen configuration changed mid-session. Corroboration required before this carries any weight.',
    },
    [EnvironmentEventType.RUNTIME_INTEGRITY_VIOLATION]: {
        ...
        cardinality: 'low',
        requiresConsent: 'assessment',
        description: 'The sandbox runtime detected tampering with its own instrumentation, such as patched APIs or a disabled reporter.',
    },
});
const INTERACTION_DEFINITIONS = define({
    ...
    [InteractionEventType.IDLE_PERIOD_DETECTED]: {
        ...
        cardinality: 'medium',
        requiresConsent: 'assessment',
        description: 'No interaction for an extended period. Thinking, reading and breaks are all ordinary; never adverse on its own.',
    },
});
const TYPING_DEFINITIONS = define({
    [TypingEventType.TYPING_BURST]: {
        ...
        cardinality: 'high',
        requiresConsent: 'assessment',
        description: 'A continuous run of typing, summarised as counts and timings. Keystroke content is never captured.',
    },
    ...
    [TypingEventType.BACKSPACE_BURST]: {
        ...
        cardinality: 'medium',
        requiresConsent: 'assessment',
        description: 'A run of corrections. Self-correction is evidence of authorship, not of weakness.',
    },
    [TypingEventType.CODE_PASTE]: {
        ...
        cardinality: 'medium',
        requiresConsent: 'assessment',
        description: 'Content was pasted into the editor. Pasting is normal developer behaviour; only the surrounding cluster gives it meaning.',
    },
    [TypingEventType.LARGE_INSERTION]: {
        ...
        cardinality: 'medium',
        requiresConsent: 'assessment',
        description: 'A single insertion far above the developer own baseline. Meaningful only when corroborated by unmodified AI output, absent testing and a failed explanation.',
    },
    ...
    [TypingEventType.REWRITE_DETECTED]: {
        ...
        cardinality: 'medium',
        requiresConsent: 'assessment',
        description: 'An existing region was substantially rewritten, evidencing engagement with code already present.',
    },
});
const CODE_EVOLUTION_DEFINITIONS = define({
    ...
    [CodeEvolutionEventType.REFACTOR_DETECTED]: {
        ...
        cardinality: 'low',
        requiresConsent: 'assessment',
        description: 'A structure-preserving transformation such as extraction or renaming, which requires understanding of the code being changed.',
    },
...
const RUNTIME_DEFINITIONS = define({
    ...
    [RuntimeEventType.BREAKPOINT_SET]: {
        ...
        cardinality: 'medium',
        requiresConsent: 'assessment',
        description: 'A breakpoint was placed. Where a developer chooses to break reveals their model of the code.',
    },
    ...
    [RuntimeEventType.ERROR_RESOLVED]: {
        ...
        cardinality: 'medium',
        requiresConsent: 'assessment',
        description: 'A previously failing condition now passes. Among the strongest available evidence of genuine problem solving.',
    },
...
const EXTERNAL_DEFINITIONS = define({
    [ExternalEventType.EXTERNAL_RESOURCE_ACCESSED]: {
        ...
        description: 'An external resource was opened, recorded by category rather than full URL. Consulting documentation is ordinary professional practice.',
    },
    ...
    [ExternalEventType.EXTERNAL_ORIGIN_IMPORT]: {
        ...
        cardinality: 'low',
        requiresConsent: 'external_monitoring',
        description: 'Code entering the workspace was correlated in time with an external resource visit. Adaptation and understanding still decide how this is read.',
    },
});
const AI_DEFINITIONS = define({
    [AiAssistanceEventType.AI_SUGGESTION_SHOWN]: {
        ...
        cardinality: 'high',
        requiresConsent: 'assessment',
        description: 'The editor displayed a code-completion suggestion. Editor-level assistance like IntelliSense; the developer remains in control of what enters the workspace.',
    },
    [AiAssistanceEventType.AI_SUGGESTION_ACCEPTED]: {
        ...
        cardinality: 'high',
        requiresConsent: 'assessment',
        description: 'A completion suggestion was accepted into the workspace. Acceptance alone is neutral; what the developer did next gives it meaning.',
    },
    [AiAssistanceEventType.AI_SUGGESTION_REJECTED]: {
        ...
        cardinality: 'medium',
        requiresConsent: 'assessment',
        description: 'A suggestion was declined or replaced with the developer own code. Rejecting a suggestion requires understanding it.',
    },
    [AiAssistanceEventType.AI_SUGGESTION_PARTIALLY_ACCEPTED]: {
        ...
        cardinality: 'medium',
        requiresConsent: 'assessment',
        description: 'Part of a suggestion was accepted and the rest declined. Selective adoption indicates the developer read and evaluated it.',
    },
    [AiAssistanceEventType.AI_SUGGESTION_MODIFIED]: {
        ...
        cardinality: 'medium',
        requiresConsent: 'assessment',
        description: 'Accepted suggestion output was subsequently changed by the developer. This is the primary signal separating assisted from dependent use.',
    },
    [AiAssistanceEventType.AI_SUGGESTION_DELETED]: {
        ...
        cardinality: 'medium',
        requiresConsent: 'assessment',
        description: 'Accepted suggestion output was later deleted, indicating review rather than blind retention.',
    },
    [AiAssistanceEventType.AI_SUGGESTION_TESTED]: {
        ...
        cardinality: 'medium',
        requiresConsent: 'assessment',
        description: 'Suggestion-derived code was executed or tested. Verifying assistance instead of trusting it is evidence of effective use.',
    },
    ...
    [AiAssistanceEventType.INLINE_COMPLETION_REJECTED]: {
        ...
        cardinality: 'high',
        requiresConsent: 'assessment',
        description: 'An inline completion was declined by continuing to type. The developer preferred their own code.',
    },
});
const SKILL_DEFINITIONS = define({
    ...
    [SkillEventType.VERIFICATION_CHALLENGE_RESULT]: {
        ...
        cardinality: 'low',
        requiresConsent: 'assessment',
        description: 'The outcome of a verification challenge. Direct, designed evidence of capability, so it may stand on its own when positive.',
    },
});
const INTERVIEW_DEFINITIONS = define({
    ...
    [InterviewEventType.INTERVIEW_ANSWER_SCORED]: {
        ...
        cardinality: 'medium',
        requiresConsent: 'recording',
        description: 'An answer was assessed for understanding. Explaining one own work is the most direct evidence of ownership.',
    },
...
const HUMAN_REVIEW_DEFINITIONS = define({
    ...
    [HumanReviewEventType.REVIEW_EVIDENCE_ACCESSED]: {
        ...
        cardinality: 'medium',
        requiresConsent: 'none',
        description: 'A reviewer accessed a specific piece of evidence. Access to a developer data is itself logged.',
    },
    [HumanReviewEventType.REVIEW_DECISION_RECORDED]: {
        ...
        cardinality: 'low',
        requiresConsent: 'none',
        description: 'A human decision of approve, reject or request review. Authoritative over the engine recommendation.',
    },
    [HumanReviewEventType.RECOMMENDATION_OVERRIDDEN]: {
        ...
        cardinality: 'low',
        requiresConsent: 'none',
        description: 'A reviewer overrode the engine recommendation, with a recorded rationale. Also the primary training signal for calibration.',
    },
...
export function eventsForLayer(layer) {
    return Object.values(EVENT_REGISTRY).filter((definition) => definition.layer === layer);
}
export function eventsRequiringConsent(scope) {
    return Object.values(EVENT_REGISTRY).filter((definition) => definition.requiresConsent === scope);
}
/** True when an event may contribute to Risk — always as part of a cluster, never alone. */
export function canContributeToRisk(type) {
