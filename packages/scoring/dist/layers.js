import { LAYER_DEFINITIONS, TrustLayer, clampUnit } from '@scora/trust-core';
import { FeaturePolarity } from '@scora/trust-features';
/**
...
export function assessLayer(layerFeatures) {
    ...
    const confidence = confidenceCount > 0 ? clampUnit(confidenceSum / confidenceCount) : clampUnit(0);
 ...
 */
export function combineStandings(assessments) {
