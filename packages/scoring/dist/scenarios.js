...
import { TEST_CONTEXT, buildSession, hexHash, payloads } from '@scora/trust-features/testing';
/**
...
export const HEAVY_ASSISTANCE_ENGAGED = [
    sessionStart,
 ...
 */
export const STRUGGLING_BEGINNER = [
    sessionStart,
