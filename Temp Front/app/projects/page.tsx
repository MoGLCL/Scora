  ...
  const projects = [
    {
      ...
      budget: "15,000 - 25,000 ج.م",
      postedTime: "منذ ساعتين",
      tags: ["Next.js", "TypeScript", "Tailwind CSS"],
      description: "نبحث عن مطور Full-Stack خبرة في Next.js لبناء لوحة تحكم التقييمات والتحليلات وإدارة الاشتراكات.",
      applicants: 8,
    },
    {
      id: "2",
      ...
      budget: "8,000 - 12,000 ج.م",
      postedTime: "منذ يوم واحد",
      tags: ["Node.js", "Express.js", "Stripe API"],
      description: "مطلوب مطور Backend لبناء موديول الدفع والفواتير الضريبية وتوثيق الـ API بمعايير أمان عالية.",
      applicants: 14,
    },
    {
      id: "3",
      title: "تطبيق هاتف ذكي لحجز خدمات الصيانة والمهام",
      clientName: "حلول تكنولوجية ش.م.م",
      budget: "30,000 - 45,000 ج.م",
      postedTime: "منذ 3 أيام",
      tags: ["Flutter", "Firebase", "REST API"],
      description: "مشروع تطوير تطبيق أندرويد وآيفون متكامل مع نظام الخرائط والإشعارات وتتبع الطلبات المباشر.",
      applicants: 22,
    },
  ];
            ...
            {projects.map((proj) => (
              ...
              >
                ...
                <div className="flex flex-wrap items-center justify-between gap-4 pt-3 border-t border-[#D1E3D6]/60">
                  ...
                  <button
                    type="button"
                    onClick={() => alert("تقديم الطلب متاح للمطورين الموثقين بعد إكمال الجواز الرقمي.")}
