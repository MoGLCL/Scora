...
export default function DeveloperOnboardingPage() {
  ...
  const [selectedSkills, setSelectedSkills] = useState<string[]>(["React.js", "Next.js", "TypeScript", "Node.js", "Python"]);

  // Step 4: Passport & Social Links
  const [github, setGithub] = useState(developer.github || "https://github.com/developer");
  const [linkedin, setLinkedin] = useState(developer.linkedin || "https://linkedin.com/in/developer");
  const [website, setWebsite] = useState(developer.website || "https://developer.dev");
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    <div className="flex items-center justify-between">
                      <label className="text-[13px] font-bold text-[#05291A]">المدينة والموقع</label>
                      <button
                        type="button"
                        onClick={handleAutoDetectLocation}
                        className="text-[11px] font-bold text-[#056B38] hover:underline flex items-center gap-1 cursor-pointer"
                      >
                    ...
                    <div className="relative flex items-center">
                      <input
                        ...
                        className="w-full h-[46px] rounded-[12px] border border-[#D1E3D6] bg-white pr-10 pl-4 text-[13px] text-[#05291A] outline-none focus:border-[#056B38]"
                      />
                      <MapPin className="w-4 h-4 text-[#526B5E] absolute right-3 pointer-events-none" />
                    </div>
                  </div>
